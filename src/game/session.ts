...
export interface Session {
  ...
  /** levels completed only with hint help — done, but no hearts earned */
  ...
  hintDir: Dir | null;
  hintT0: number;
  /** the player peeked at a hint this level run — the win earns no hearts */
  hintUsed: boolean;
...
export function blankSession(): Session {
  ...
  return {
    ...
    mode: 'idle', pending: null, results: {}, hinted: {}, daily: {},
    ...
    hintDir: null, hintT0: 0, hintUsed: false, lastMovers: null,
