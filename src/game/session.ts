...
/* v3: the endless ramp steepened (41+ climbs visibly) — levels cached under
   older keys were generated by flatter ramps and must not survive */
const GEN_KEY = 'squish-gen-v3:';
